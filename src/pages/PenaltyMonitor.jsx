...
const handleShowBreakdown = async (userId, groupId, userName, groupName, cachedPenaltyData = null) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Group Name",
      render: (text) => (
        <Tag color="violet" className="font-medium">
          {text}
        </Tag>
      ),
    },
...

{
  ...
  render: (v, row) =>
    ...
    //   align: "right",
    //   render: (v) => (
    //     <span className={v > 0 ? "text-violet-600 font-medium" : "text-gray-500"}>
    //       ₹{v?.toFixed(2)}
    //     </span>
    //   ),
    // },
                ...
                <Col xs={24} sm={12} md={4}>
                  <Card className="shadow-sm border border-gray-200">
                    <Statistic
                      ...
                      prefix={<UsergroupAddOutlined className="text-violet-500" />}
